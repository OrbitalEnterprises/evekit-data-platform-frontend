...
public class ReleaseWS {
  public static final String PROP_BUILD_DATE = "enterprises.orbital.evekit.dataplatform.build";
  public static final String PROP_VERSION    = "enterprises.orbital.evekit.dataplatform.version";
